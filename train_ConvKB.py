...
parser.add_argument("--nbatches", default=100,
...
parser.add_argument(
    "--mode", choices=["train", "predict"], default="train", type=str)
...
if args.mode == "train":
    ...
    if args.use_init:
        ...
        r2id, id2r = get_term_id(
            filename="./benchmarks/" + args.dataset + "/relation2id.txt")
        r2id50, id2r50 = get_term_id(
            filename="./benchmarks/" + args.dataset + "/relation2id_"+hidden_size+"init.txt")
